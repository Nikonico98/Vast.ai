...
from config import (
    ...
    HF_TOKEN, TEMP_FOLDER, RESULT_FOLDER, RIGANYTHING_REPO
)
...
def _run_3d_pipeline_internal(job_id: str, image_path: str, prompt: str,
    ...
    try:
        ...
        update_job_status(job_id, "processing", "Post-processing Complete", 95)
        ...
        log(job_id, f"   - RigAnything: {rig_time:.1f}s {'✅' if rig_success else '⚠️ skipped/failed'}")
